...
const title = "About Aulukya Fire & Safety Solutions | Fire Safety Company in Chennai"
const description =
...
const whatWeDo = [
  {
    ...
    description: "Supply and support for extinguishers and other workplace fire safety equipment.",
  },
  {
    title: "System installation",
    description: "Professional installation for fire alarm, hydrant and related protection systems.",
  },
  {
    title: "Maintenance and AMC",
    description: "Ongoing servicing that keeps your systems ready and compliant over time.",
  },
  {
    title: "Audits and compliance",
    description: "Practical fire safety audits and support for workplace compliance requirements.",
  },
  {
    title: "Fire NOC consulting",
    description: "Guidance to help clients navigate fire NOC needs with greater clarity.",
  },
  {
    title: "Safety PPE",
    description: "Reliable protective equipment that supports safer work environments.",
  },
  {
    title: "Emergency readiness",
    description: "Support for improving preparedness, response and workplace safety awareness.",
  },
  {
    title: "Local fire safety support",
    description: "Chennai-focused service for businesses needing consistent, responsive help.",
  },
] as const
...
const values = [
  {
    title: "Safety First",
    description: "We prioritise dependable fire protection outcomes before anything else.",
    icon: ShieldCheck,
  },
  {
    title: "Quality in Execution",
    description: "Every installation, inspection and maintenance step is handled with care.",
    icon: Target,
  },
  {
    title: "Reliable Support",
    description: "Clients get clear communication, timely follow-up and dependable service.",
    icon: Headset,
  },
  {
    title: "Customer Focus",
    description: "We tailor fire safety support around the real needs of each workplace.",
    icon: Check,
  },
] as const
  ...
  return (
    <p
      className={cn(
        ...
        light ? "text-red-400 before:bg-red-500" : "text-red-700 before:bg-red-700"
      )}
    >
      {children}
    </p>
  ...
  return (
    <>
      <section className="relative isolate -mt-[88px] overflow-hidden bg-zinc-950 pt-[88px] text-white">
        ...
        <Container className="flex min-h-[580px] items-end py-16 sm:min-h-[660px] sm:py-20 lg:min-h-[740px] lg:items-center lg:py-28">
          <div className="max-w-3xl animate-in duration-700 fade-in slide-in-from-bottom-4">
            ...
            <p className="mt-6 max-w-xl text-base leading-7 text-white/72 sm:text-lg">
              A Chennai-based fire safety company providing reliable fire protection, safety equipment, installation, maintenance and compliance support.
            </p>
            <Link
              href="/contact"
              className={cn(
        ...
        <Container className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20">
          ...
          <div>
            ...
            <div className="mt-7 max-w-2xl space-y-5 text-base leading-8 text-zinc-600">
              <p>
                Aulukya provides reliable fire safety solutions for businesses across Chennai, from equipment and system installation to ongoing maintenance and compliance support.
              </p>
              <p>
                We focus on practical, dependable solutions that help workplaces stay protected and prepared.
              </p>
            </div>
            <div className="mt-10">
                ...
                {services.map((service) => {
                  ...
                  return (
                    <Link
                      key={service.title}
                      href="/services"
                      className="flex items-center gap-4 text-left text-sm font-medium leading-6 text-zinc-900 transition-colors hover:text-red-700 sm:text-base"
                    >
        ...
        <Container>
          ...
          <div className="mt-12 grid gap-0 lg:grid-cols-2">
            {whatWeDo.map((item, index) => (
              <article
                key={item.title}
                className={cn("py-6 sm:py-7", index % 2 === 0 ? "lg:pr-10" : "lg:pl-10")}
              >
                <div className="flex items-start gap-4">
                  <IconBadge size="sm" className="mt-1">
                    {index % 4 === 0 ? <Flame className="size-5" aria-hidden="true" /> : null}
                    {index % 4 === 1 ? <ShieldCheck className="size-5" aria-hidden="true" /> : null}
                    {index % 4 === 2 ? <Target className="size-5" aria-hidden="true" /> : null}
                    {index % 4 === 3 ? <Sparkles className="size-5" aria-hidden="true" /> : null}
                  </IconBadge>
                  <div>
                    <h3 className="font-heading text-2xl font-semibold tracking-[-0.03em] text-zinc-950">
                      {item.title}
                    </h3>
                    <p className="mt-2 max-w-xl text-sm leading-7 text-zinc-600">{item.description}</p>
                  </div>
                </div>
              </article>
            ))}
        ...
        <Container>
          ...
          <div className="mt-12 grid items-stretch gap-6 lg:grid-cols-2 lg:gap-8">
            <article className="flex h-full min-h-0 flex-col overflow-hidden rounded-[1.75rem] border border-zinc-200 bg-white shadow-[0_18px_60px_-42px_rgba(0,0,0,0.35)] lg:min-h-[36rem]">
              ...
              <div className="flex flex-1 min-h-0 flex-col px-6 py-6 sm:px-8 sm:py-8">
                <p className="text-[20px] font-bold tracking-[0.24em] text-red-700 uppercase">Mission</p>
                ...
                <p className="mt-5 flex-1 text-base leading-7 text-zinc-600 sm:leading-8">
                  We provide reliable fire protection solutions that help businesses stay prepared, protected and compliant.
                </p>
              </div>
            </article>
            <article className="flex h-full min-h-0 flex-col overflow-hidden rounded-[1.75rem] border border-zinc-200 bg-white shadow-[0_18px_60px_-42px_rgba(0,0,0,0.35)] lg:min-h-[36rem]">
              ...
              <div className="flex flex-1 min-h-0 flex-col px-6 py-6 sm:px-8 sm:py-8">
                <p className="text-[20px] font-bold tracking-[0.24em] text-red-700 uppercase">Vision</p>
                <div className="mt-3 h-px w-12 bg-red-600/35" />
                <h3 className="mt-4 font-heading text-[24px] font-semibold tracking-[-0.03em] text-zinc-950 sm:text-[24px]">
                  Be a trusted fire safety partner for workplaces across Chennai.
                </h3>
                <p className="mt-5 flex-1 text-base leading-7 text-zinc-600 sm:leading-8">
                  We aim to support safer workplaces through reliable service, stronger preparedness and clear guidance on day-to-day fire protection needs.
                </p>
              </div>
            </article>
          </div>
      ...
      <section className="overflow-x-clip overflow-hidden bg-zinc-50 py-16 text-white sm:py-20 lg:py-24">
        <Container className="max-w-[1440px]">
          <div className="max-w-3xl text-left">
            ...
            <p className="mt-4 max-w-2xl text-base leading-7 text-zinc-600 sm:text-lg sm:leading-8">
              We follow a clear, collaborative process to understand your requirements, deliver the right solutions and keep your workplace protected over time.
            </p>
          </div>

          <div className="mt-8 sm:mt-10">
            <div className="relative aspect-[16/10] min-h-[240px] w-full overflow-hidden rounded-[1.5rem] border border-white/10 bg-zinc-900 shadow-[0_24px_70px_-42px_rgba(0,0,0,0.75)] sm:aspect-[16/9] sm:rounded-[2rem] sm:min-h-[320px] lg:min-h-[380px]">
              <Image
                src="/about-fire-inspection.png"
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <button
                  ...
                  className="group flex size-20 items-center justify-center rounded-full border border-white/20 bg-white/10 shadow-[0_18px_50px_-22px_rgba(0,0,0,0.8)] backdrop-blur-md transition duration-300 hover:scale-105 hover:bg-white/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-4 focus-visible:ring-offset-zinc-950 sm:size-24"
                >
                  <span className="flex size-14 items-center justify-center rounded-full bg-red-600 text-white shadow-[0_10px_24px_-12px_rgba(220,38,38,0.9)] transition-transform duration-300 group-hover:scale-105 sm:size-16">
                    <Play className="ml-0.5 size-6 fill-current sm:size-7" aria-hidden="true" />
                  </span>
                </button>
              </div>
            </div>
      ...
      <section className="bg-white py-20 text-zinc-950 sm:py-24 lg:py-28">
        <Container className="rounded-[2rem] bg-[#fcfcfd] px-4 py-4 shadow-[0_30px_80px_-50px_rgba(0,0,0,0.18)] ring-1 ring-zinc-100 sm:px-5 sm:py-5 lg:px-6 lg:py-6">
          <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-12">
            <div className="relative min-h-[360px] overflow-hidden rounded-[1.6rem] bg-zinc-100 shadow-[0_24px_70px_-42px_rgba(0,0,0,0.26)] sm:min-h-[520px] lg:min-h-[620px]">
              <Image
                src="/home-why-fire-safety.jpeg"
                alt="Fire safety support in Chennai"
                fill
                sizes="(min-width: 1024px) 44vw, 100vw"
                className="object-cover object-[48%_center]"
              />
              <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.08)_0%,rgba(0,0,0,0.05)_48%,rgba(0,0,0,0.2)_100%)]" />
            </div>

            <div className="max-w-2xl py-2 sm:py-3 lg:pl-2">
              <Eyebrow>CHENNAI FOCUSED</Eyebrow>
              <h2 className="mt-5 max-w-3xl font-heading text-4xl font-semibold tracking-[-0.045em] text-balance sm:text-5xl lg:text-[4rem] lg:leading-[1.03]">
                Fire safety support, close to your business.
              </h2>
              <p className="mt-5 max-w-2xl text-base leading-8 text-zinc-600 sm:text-[1.05rem]">
                Based in Pallavaram, Chennai, we support businesses with dependable fire protection,
                maintenance, audits and compliance services.
              </p>

              <div className="relative mt-8 overflow-hidden rounded-[1.6rem] bg-[#fbf2f2] px-5 py-5 shadow-[0_18px_48px_-34px_rgba(220,38,38,0.38)] ring-1 ring-red-100 sm:px-6 sm:py-6">
                <div className="pointer-events-none absolute inset-0">
                  <div className="absolute right-6 top-5 h-28 w-28 rounded-full border border-red-200/70" />
                  <div className="absolute right-20 top-10 h-16 w-16 rounded-full border border-red-200/60" />
                  <svg
                    aria-hidden="true"
                    viewBox="0 0 420 170"
                    className="absolute bottom-0 right-0 h-[8.5rem] w-[21rem] text-red-200/80 sm:h-[9.5rem] sm:w-[24rem]"
                    fill="none"
                  >
                    <path
                    ...
                    />
                    <path d="M82 150 v-10 h12 v10 M103 150 v-24 h18 v24 M126 150 v-16 h10 v16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>

                <div className="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:gap-6">
                  <div className="flex shrink-0 items-center justify-center">
                    <div className="relative flex size-20 items-center justify-center rounded-full bg-white/70 ring-1 ring-red-100 shadow-[0_12px_30px_-20px_rgba(220,38,38,0.55)] sm:size-24">
                      <MapPin className="size-9 fill-red-600 text-red-600 sm:size-10" aria-hidden="true" />
                    </div>
                  </div>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-4 max-w-xl text-sm leading-7 text-zinc-600 sm:text-[0.98rem]">
                      Serving businesses across Chennai with practical, responsive fire safety support.
                    </p>
                  </div>

                  <div className="absolute right-4 top-4 hidden items-center justify-center sm:flex">
                    <MapPin className="size-5 fill-red-600 text-red-600" aria-hidden="true" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4 lg:gap-7">
            {values.map((value) => (
              ...
              >
                ...
                <p className="mt-4 max-w-sm text-sm leading-7 text-white/60">{value.description}</p>
              </article>
            ))}
          </div>
        </Container>
      ...
      <section className="relative overflow-hidden bg-[linear-gradient(90deg,#060000_0%,#170000_26%,#2b0000_56%,#6b0404_78%,#f01313_100%)] text-white">
        ...
        <div className="relative mx-auto flex min-h-[300px] max-w-6xl flex-col items-center justify-center px-4 py-16 text-center sm:px-6 lg:px-8 lg:py-20">
          ...
          <h2 className="mt-5 max-w-5xl text-4xl font-semibold tracking-[-0.04em] text-balance sm:text-5xl md:text-6xl lg:text-[4.25rem] lg:leading-[0.95]">
            Build a safer workplace with Aulukya.
          </h2>
          <p className="mt-6 max-w-3xl text-sm leading-7 text-white/88 sm:text-base">
            Talk to our team about reliable fire protection, maintenance and
            compliance solutions for your workplace.
          </p>
          <Link
            href="/contact"
